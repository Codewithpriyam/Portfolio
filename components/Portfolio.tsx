    ...
    return (
        ...
        >
            ...
            <span className="absolute left-1/2 -translate-x-1/2 text-[12px] font-medium text-white/50 pointer-events-none tracking-wide flex items-center gap-1.5">
                <span className="text-[10px]">📁</span> priyam.dev
            </span>
        </div>
    );
}
        ...
        >
            ...
            >
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                    {["Java", "Spring Boot", "React.js", "REST APIs", "MongoDB", "MySQL", "Postman"].map(
                        (tag, i) => (
                            <span
                                key={tag}
                ...
                <p className="text-[13px] text-white/60 leading-relaxed mb-5" style={{ fontWeight: 450 }}>
                    Building scalable web apps, backend systems with Spring Boot, and responsive UI experiences with React.js.
                </p>

                {/* Social Links */}
                <div className="flex flex-wrap gap-2.5 mb-8">
                    <a
                        href="https://github.com/Codewithpriyam"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <a
                        href="https://www.linkedin.com/in/priyam-kumar-5057a123b/"
                        target="_blank"
                        rel="noreferrer"
