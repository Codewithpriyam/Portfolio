...
export default function SafariWindow({ onClose }: SafariWindowProps) {
  ...
  const handleUrlSubmit = (e: React.FormEvent) => {
    ...
    } else if (query.toLowerCase().includes('github') || query.toLowerCase().includes('priyam')) {
      navigateTo('github', 'https://github.com/Codewithpriyam');
    } else if (query.toLowerCase().includes('linkedin')) {
      navigateTo('linkedin', 'https://www.linkedin.com/in/priyam-kumar-5057a123b/');
    } else {
        ...
        {currentTab === 'start' && (
          <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-b from-[#1c1c1e] to-[#121214]">
            ...
            <div className="grid grid-cols-4 gap-8 max-w-lg w-full">
              ...
              {/* GitHub Link */}
              <div
                onClick={() => window.open('https://github.com/Codewithpriyam', '_blank')}
                className="flex flex-col items-center gap-2 cursor-pointer group"
              >
              ...
              {/* LinkedIn Link */}
              <div
                onClick={() => window.open('https://www.linkedin.com/in/priyam-kumar-5057a123b/', '_blank')}
                className="flex flex-col items-center gap-2 cursor-pointer group"
              >
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#202124] text-white">
            ...
            <form onSubmit={handleGoogleSearch} className="w-full max-w-xl">
              ...
              <div className="flex justify-center gap-3 mt-8">
                ...
                <button
                  type="button"
                  onClick={() => { setSearchQuery('Priyam Kumar portfolio'); navigateTo('google-results', 'https://www.google.com/search?q=Priyam+Kumar+portfolio'); }}
          ...
          <div className="flex-1 bg-[#202124] text-white p-6 flex flex-col font-sans select-text">
            ...
            <div className="flex items-center gap-4 pb-4 border-b border-[#303134] mb-4">
              ...
              <div className="bg-[#303134] rounded-full px-4 py-1.5 text-xs text-white/80 w-80">
                {searchQuery || 'Priyam Kumar portfolio'}
              </div>
            </div>

            <p className="text-xs text-white/40 mb-5">About 150,000 results (0.21 seconds)</p>

            {/* Result 1: Main Portfolio Link */}
            <div className="mb-6 max-w-xl">
              <span className="text-[11px] text-white/50 block">priyam.dev</span>
              <h3
              ...
              >
                Priyam Kumar | Software Engineer & Full Stack Portfolio
              </h3>
              <p className="text-xs text-white/70 mt-1 leading-normal">
                Welcome to my interactive macOS-themed portfolio. Explore my tech stack via terminal, view gallery photos, or get in touch. Built with React and Next.js.
              </p>
            </div>

            {/* Result 2: GitHub profile */}
            <div className="mb-6 max-w-xl">
              <span className="text-[11px] text-white/50 block">github.com › Codewithpriyam</span>
              <h3
                onClick={() => window.open('https://github.com/Codewithpriyam', '_blank')}
                className="text-sky-400 hover:underline cursor-pointer text-lg font-medium leading-tight mt-0.5"
              >
                Codewithpriyam (Priyam Kumar) · GitHub
              </h3>
              <p className="text-xs text-white/70 mt-1 leading-normal">
                Priyam Kumar - Full Stack Developer. Code repositories for Java, Spring Boot, React.js, and REST API projects.
              </p>
            </div>

            {/* Result 3: LinkedIn Profile */}
            <div className="mb-6 max-w-xl">
              <span className="text-[11px] text-white/50 block">linkedin.com › in › priyam-kumar-5057a123b</span>
              <h3
                onClick={() => window.open('https://www.linkedin.com/in/priyam-kumar-5057a123b/', '_blank')}
                className="text-sky-400 hover:underline cursor-pointer text-lg font-medium leading-tight mt-0.5"
              >
                Priyam Kumar - Full Stack Developer - LinkedIn
              </h3>
              <p className="text-xs text-white/70 mt-1 leading-normal">
                View Priyam Kumar's professional profile on LinkedIn. Connecting technologies, Java, Spring Boot, backend APIs, and React architectures to drive engineering value.
              </p>
            </div>
          </div>
        )}
        ...
        {currentTab === 'github' && (
          <div className="flex-1 bg-[#0d1117] text-[#c9d1d9] font-sans p-6 select-text flex flex-col">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[#21262d] mb-6">
              ...
              <button onClick={() => window.open('https://github.com/Codewithpriyam', '_blank')} className="px-3 py-1 bg-[#21262d] hover:bg-[#30363d] rounded text-xs font-semibold text-[#c9d1d9] border border-[#30363d]">
                Open in Github
              </button>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div className="w-1/3 flex flex-col items-center">
                ...
                <h2 className="text-xl font-bold text-[#f0f6fc]">Priyam Kumar</h2>
                <span className="text-sm text-[#8b949e]">Codewithpriyam</span>
                <p className="text-xs text-[#8b949e] mt-4 text-center">
                  Full Stack Developer | Building applications with Java, Spring Boot, React.js, and REST APIs.
                </p>
              </div>

              {/* Repositories */}
              <div className="flex-1 flex flex-col">
                <h3 className="text-sm font-semibold text-[#f0f6fc] border-b border-[#21262d] pb-2 mb-4">Repositories</h3>
                <p className="text-xs text-[#8b949e]">Visit <a href="https://github.com/Codewithpriyam" target="_blank" rel="noreferrer" className="text-[#58a6ff] underline">github.com/Codewithpriyam</a> to view full list of projects.</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="flex-1 bg-[#f3f3f3] text-neutral-800 font-sans p-6 select-text flex flex-col justify-center items-center">
            <div className="w-full max-w-md bg-white border border-neutral-200 rounded-xl overflow-hidden shadow-md">
              ...
              <div className="px-6 pb-6 relative flex flex-col items-center">
                ...
                <h2 className="text-lg font-bold text-neutral-800">Priyam Kumar</h2>
                <p className="text-xs text-neutral-500 text-center font-medium mt-0.5">Full Stack Developer</p>
