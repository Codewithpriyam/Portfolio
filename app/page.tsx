      ...
      <div className={`${styles.desktopArea} hidden md:flex`}>
        <div className={styles.iconGrid}>
          {PROJECTS.map((project) => (
            <DraggableIcon key={project.id}>
              <DesktopIcon
                label={project.name}
                iconPath={project.icon.startsWith('/') ? project.icon : undefined}
                onClick={() => {
        ...
        <div className={styles.windowArea} style={{ position: 'relative' }}>
          ...
          <div style={{
            ...
            <BubbleText className={`${aubrey.className} ${styles.welcomeTextSmall}`}>Hey, I'm Priyam! welcome to my</BubbleText>
